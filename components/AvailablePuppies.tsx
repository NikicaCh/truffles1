          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {reservedDogs.map((dog, index) => (
                ...
                >
                  <Card
                    className="overflow-hidden hover:shadow-lg transition-all duration-300 opacity-75 cursor-pointer"
                    role="link"
                    tabIndex={0}
                    onClick={() => openDog(dog.id)}
                    onKeyDown={(e) => {
                  ...
                  >
                    <div className="relative">
                      <ImageWithFallback
                        ...
                        className="w-full h-64 object-cover"
                      />
                      <Badge className="absolute top-4 right-4 bg-blue-500">Reserved</Badge>
                    </div>
                    ...
                    <CardContent className="space-y-4">
                      <p className="text-sm text-muted-foreground">
                        This {dog.gender.toLowerCase()} has found a loving home! View profile to see what makes our dogs
                        special.
                      </p>
