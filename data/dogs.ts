...
export const availableDogs: Dog[] = [
  {
    id: "puppy-astra-igor-2026",
    name: "Astra x Igor Puppy",
    gender: "Female",
    birthDate: "March 20, 2026",
    age: "Expected Spring 2026",
    color: "To be determined",
    weight: "To be determined",
    status: "Available",
    parents: {
      sire: "JCH MK Igor del Casale Brioso",
      dam: "JCH Astra from Truffles Macedonia"
    },
    description:
      "Poster-based puppy listing from the Astra x Igor pairing. Individual puppy photos are not published yet.",
    personality: ["Friendly", "Balanced temperament", "Active"],
    healthInfo: {
    ...
    images: [
      "/POSTERS/litter-astra-igor.png"
    ],
    features: [
      "Poster announcement",
      "Champion bloodlines",
      "Health-tested parent pair"
    ],
    suitableFor: [
      "Families",
      "Companion homes",
  ...
  {
    id: "puppy-lara-igor-2026",
    name: "Lara x Igor Puppy",
    gender: "Male",
    ...
    parents: {
      sire: "JCH MK Igor del Casale Brioso",
      dam: "Lara from Truffles Macedonia"
    },
    description:
      "Poster-based puppy listing from the Lara x Igor pairing. Individual puppy photos are not published yet.",
    personality: ["Confident", "Smart", "Friendly"],
    healthInfo: {
      geneticTesting: "All Clear",
      hips: "Excellent",
      elbows: "Excellent",
...
export const getAnyDogById = (id: string): Dog | undefined => {
  return availableDogs.find((dog) => dog.id === id) || ourDogs.find((dog) => dog.id === id);
};
...
export const HAS_AVAILABLE_PUPPIES = true;
