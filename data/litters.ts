...
export const ALL_LITTERS: Litter[] = [
  {
    ...
    slug: "astra-igor-september-2026",
    title: "Astra x Igor Litter",
    monthYear: "September 2026",
    dateLabel: "Born September 8, 2026",
    dateISO: "2026-09-08",
    dateKind: "born",
    puppyCount: "Born - updates soon",
    description:
      "Astra x Igor puppies were born on September 8th, 2026. Both parents are genetically clear with perfect hips and elbows.",
